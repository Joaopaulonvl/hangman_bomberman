    ...
    function updateWordDisplay() {
        ...
        if (!show.includes("_")) {
            ...
            setTimeout(function(){
                soundWin.volume = 0.3;
                soundWin.play();
                $("h1").text("YOU WIN!!").fadeOut(200).fadeIn(200).fadeOut(200).fadeIn(200).fadeOut(200).fadeIn(200);
                setTimeout(function(){
                        $("h1").text("PRESS RESET BUTTON TO PLAY AGAIN").fadeOut(200).fadeIn(200).css("color","white");
                    }, 2000);
            },3000);
        }
    }
    ...
    function checkUserAnswer(letter) {
        ...
        if (errors >= errorLimit) {
            ...
            setTimeout(function(){
                ...
                setTimeout(function(){
                    $("h1").text("YOU LOSE!").fadeOut(200).fadeIn(200).fadeOut(200).fadeIn(200).fadeOut(200).fadeIn(200);
